            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="${pageContext.request.contextPath}/borrowed">View Borrowed</a></li>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <c:forEach var="card" items="${cardList}">
                                            ...
                                            <td>${card.address}</td>
                                            <td>${card.phone}</td>
                                            <td>${card.dateOfError}</td>
                                            <td>${card.expirationDate}</td>
                                            <td>${card.paymentDate}</td>
                                            <td>${card.price}</td>
                                            <td>${card.libarycode}</td>
                                            <td><a href="deleteCard/${card.cardId}">Delete</a></td>                        
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                    </c:if>
