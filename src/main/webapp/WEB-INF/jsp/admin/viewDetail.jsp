                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <mvc:input  path="studentId" readonly="true"
                                            class="form-control form-control-line"/> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Student Name</label>
                                    <div class="col-md-12">
                                        <mvc:input path="studentName" required="true"
                                            class="form-control form-control-line"/> </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-12">Student Classr</label>
                                    <div class="col-md-12">
                                        <mvc:input path="studentClassr" required="true"
                                            class="form-control form-control-line"/> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <mvc:input path="city" required="true"
                                            class="form-control form-control-line"/> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Sex</label>
                                    <div class="col-md-12">
                                        <mvc:input path="Sex" required="true" class="form-control form-control-line"/> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">BirthDate</label>
                                    <div class="col-md-12">
                                        <mvc:input path="birDate" required="true" type="date" class="form-control form-control-line"/> </div>
                                </div>                   
                                <div class="form-group">
                                    <div class="col-sm-12">
