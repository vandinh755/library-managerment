...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Page Content -->
        <mvc:form modelAttribute="book" action="${pageContext.request.contextPath}/updateBook" method="post" >
        <div id="page-wrapper">
                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <mvc:input  path="bookID" readonly="true"
                                            class="form-control form-control-line"/> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Book Name</label>
                                    <div class="col-md-12">
                                        <mvc:input  path="bookName" required="true"
                                            class="form-control form-control-line"/> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Book Informaton</label>
                                    <div class="col-md-12">
                                        <mvc:input  path="bookInformaton" required="true"
                                            class="form-control form-control-line"/> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Author</label>
                                    <div class="col-md-12">
                                        <mvc:input path="author" required="true" class="form-control form-control-line"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Producer</label>
                                    <div class="col-md-12">
                                        <mvc:input path="producer" required="true" class="form-control form-control-line"/>
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-12">Image</label>
                                    <div class="col-md-12">
                                        <mvc:input path="image" required="true" class="form-control form-control-line"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Category</label>
                                    <div class="col-md-12">
                                        <mvc:select type="categoey" path="category.categoryID" items="${categoryID}"
                                            class="form-control form-control-line"/> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Date</label>
                                    <div class="col-md-12">
                                        <mvc:input path="dates" required= "true" type="date"
                                            class="form-control form-control-line"/> </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
