<%-- 
    Document   : map-google
    Created on : 24-11-2020, 09:20:37
    Author     : ACER
--%>
...
<body>
    ...
    <script src="<c:url value='/resources/admin/plugins/bower_components/gmaps/gmaps.min.js'/>"></script>
    <script src="<c:url value='/resources/admin/plugins/bower_components/gmaps/jquery.gmaps.js'/>"></script>
</body>
