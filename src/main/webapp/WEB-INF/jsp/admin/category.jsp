...
"></i></a>
                ...
                <ul class="nav navbar-top-links navbar-left m-l-20 hidden-xs">
                    <li>
                        <form  action="${pageContext.request.contextPath}/searchCategory" method="get" class="app-search hidden-xs">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">List category Table</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="${pageContext.request.contextPath}/addNewCategory">ADD NEW CATEGORY</a></li>
                            <li ><a href="${pageContext.request.contextPath}/category" class="active">List category Table</a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
